...
<body>
    ...
    <div style="background-color: gold" class="container">
        <div class="container">

            <h3>{{ 'Title is  = '.$data[0]->title}}</h3>
            <br>
            <div class="card w-25 text-bold">{{'Content is  = '.$data[0]->content}}</div>
            <p>
            <div>Image:</div><br>
        ...
        <p>
            ...
            {{'Time is  = '.  $data[0]->pu_date}}
        </p>
        
        <p>
            {{
                'By , '.$data[0]->WriterName
            }}
    </p>
...
<div class="container blog-page m-5">
    <div class="row clearfix">
        <div class="col-lg-4 col-md-12">
            <div class="card single_post">
                ...
                <div class="body">
                    <h3 class="m-t-0 m-b-5"><a href="blog-details.html">{{$data[0]->title}}</a></h3>
                    <ul class="meta">
                        <li><a href="javascript:void(0);"><i class="zmdi zmdi-account col-blue"></i>Posted By: {{ $data[0]->WriterName }}</a></li>
                        <li><a href="javascript:void(0);"><i class="zmdi zmdi-label col-amber"></i>{{ $data[0]->pu_date }}</a></li>
                        <li><a href="javascript:void(0);"><i class="zmdi zmdi-comment-text col-blue"></i>Comments: 3</a></li>
                    </ul>
                </div>
                <div class="body">
                    <div class="img-post m-b-15">
                        <img src="{{url('/blogs/'.$data[0]->image)}}" width="600px" alt="Awesome Image">
